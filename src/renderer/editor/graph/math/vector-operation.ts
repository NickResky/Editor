...
export class AddVectors extends GraphNode {
    ...
    public constructor() {
        ...
        this.addInput("a *", "vec2,vec3");
        this.addInput("b *", "vec2,vec3");

        this.addOutput("", "vec2,vec3");
    }
    ...
    public execute(): void {
        ...
        const b = this.getInputData(0) as Vector2 | Vector3;
    ...
    public disconnectInput(slot: string | number): boolean {
        ...
        if (!this.isInputConnected(0) && !this.isInputConnected(1)) {
            this.setOutputDataType(0, "vec2,vec3");
            this.inputs[0].type = "vec2,vec3";
            this.inputs[1].type = "vec2,vec3";
        }
